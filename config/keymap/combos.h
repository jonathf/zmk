...
#define _combo_z(layer, key) ZMK_COMBO(_Z_ ## layer, key, _LL4 _LL3, layer)
_combo_z(0, &kp Z)
_combo_z(1, &kp LS(N5))
_combo_z(4, &kp Z)
_combo_z(5, &kp PRCNT)
...
#define _combo_oe(layer, key) ZMK_COMBO(_OE_ ## layer, key, _LL3 _LL2, layer)
_combo_oe(0, _1_OE)
_combo_oe(4, _0_OE)

#define _combo_aa(layer, key) ZMK_COMBO(_AA_ ## layer, key, _UL3 _UL2, layer)
_combo_aa(0, _1_AA)
_combo_aa(1, &kp LS(FSLH))
_combo_aa(4, _0_AA)

#define _combo_ae(layer, key) ZMK_COMBO(_AE_ ## layer, key, _LR3 _LR4, layer)
_combo_ae(0, _1_AE)
_combo_ae(4, _0_AE)
